...
const Layout = () => {
  ...
  return (
    <>
      <Head>
        <title>
          SharedWallet - create a joint crypto wallet with your family and
          friends
        </title>
      </Head>
      <div className="contain">
        ...
        <div className="box3 col-span-4 p-8 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex flex-col items-center ">
          ...
          {!isAccountHolder && isUser ? (
            ...
            <>
              <p className="disclaimer">
                <b>Disclaimer:</b> Only an account holder can add user to
                his/her account.
              </p>
              <br />
              <p className="disclaimer">
                <b>Reminder:</b> The user will get access to deposit and
